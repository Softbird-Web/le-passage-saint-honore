  ...
  return (
    <section className="section cream" id="instagram">
      <div className="max">
        ...
        <span className="eyebrow" style={{ marginTop: 18 }}>@{brand.social.instagram}…</span>

        <div className="insta-lead" style={{ marginTop: 32 }}>
          <h2 className="display" data-words-pullup style={{ maxWidth: '14ch' }}>
            La&nbsp;vie&nbsp;<span className="ital">au&nbsp;Passage.</span>
          </h2>
          <div className="cta-wrap">
            <a className="btn deep-red" href={brand.social.instagramUrl} target="_blank" rel="noopener noreferrer">
              Nous suivre <span className="arrow">↗</span>
            </a>
          </div>
        </div>
        ...
        <div className="insta-cb" data-card-stagger>
          <a className="insta-cb-card" data-card href={brand.social.instagramUrl} target="_blank" rel="noopener noreferrer">
            ...
            <div className="meta">
              ...
              <div className="chip"><span className="dot">L</span><span className="handle">{brand.social.instagram}</span><span className="check">✓</span></div>
            </div>
          </a>
